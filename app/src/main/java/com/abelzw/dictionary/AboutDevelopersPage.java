...
public class AboutDevelopersPage {
    ...
    /**
     * The AboutAppPage requires a context to perform it's functions. Give it a context associated to an
     ...
     * @param context
     */
    public AboutDevelopersPage(Context context) {
        this.mContext = context;
        this.mInflater = LayoutInflater.from(context);
        this.mView = mInflater.inflate(R.layout.about_developers_page, null);
    }

    /**
     * Provide a valid path to a font here to use another font for the text inside this AboutAppPage
     *
     * @param path
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage setCustomFont(String path) {
    ...
    /**
     * Convenience method for {@link AboutDevelopersPage#addEmail(String, String)} but with
     * a predefined title string
     *
     * @param email the email address to send to
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addEmail(String email) {
     ...
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addEmail(String email, String title) {
    ...
    /**
     * Convenience method for {@link AboutDevelopersPage#addFacebook(String, String)} but with
     * a predefined title string
     *
     * @param id the facebook id to display
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addFacebook(String id) {
     ...
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addFacebook(String id, String title) {
        ...
        if (AboutDevelopersPageUtils.isAppInstalled(mContext, "com.facebook.katana")) {
    ...
    /**
     * Convenience method for {@link AboutDevelopersPage#addTwitter(String, String)} but with
     * a predefined title string
     *
     * @param id the Twitter id to display
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addTwitter(String id) {
     ...
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addTwitter(String id, String title) {
        ...
        if (AboutDevelopersPageUtils.isAppInstalled(mContext, "com.twitter.android")) {
    ...
    /**
     * Convenience method for {@link AboutDevelopersPage#addPlayStore(String, String)} but with
     * a predefined title string
     *
     * @param id the package id of the app to display
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addPlayStore(String id) {
     ...
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addPlayStore(String id, String title) {
    ...
    /**
     * Convenience method for {@link AboutDevelopersPage#addYoutube(String, String)} but with
     * a predefined title string
     *
     * @param id the id of the channel to deep link to
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addYoutube(String id) {
     ...
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addYoutube(String id, String title) {
        ...
        if (AboutDevelopersPageUtils.isAppInstalled(mContext, "com.google.android.youtube")) {
    ...
    /**
     * Convenience method for {@link AboutDevelopersPage#addInstagram(String, String)} (String, String)} but with
     * a predefined title string
     *
     * @param id the id of the ic_instagram user to deep link to
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addInstagram(String id) {
     ...
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addInstagram(String id, String title) {
        ...
        if (AboutDevelopersPageUtils.isAppInstalled(mContext, "com.instagram.android")) {
    ...
    /**
     * Convenience method for {@link AboutDevelopersPage#addGitHub(String, String)} but with
     * a predefined title string
     *
     * @param id the id of the GitHub user to display
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addGitHub(String id) {
     ...
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addGitHub(String id, String title) {
    ...
    /**
     * Convenience method for {@link AboutDevelopersPage#addWebsite(String, String)} but with
     * a predefined title string
     *
     * @param url the URL to open in a browser
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addWebsite(String url) {
     ...
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addWebsite(String url, String title) {
    ...
    /**
     * Add a custom {@link Element} to this AboutAppPage
     *
     * @param element
     * @return this AboutAppPage instance for builder pattern support
     * @see Element
     */
    public AboutDevelopersPage addItem(Element element) {
    ...
    /**
     * Set the header image to display in this AboutAppPage
     *
     * @param resource the resource id of the image to display
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage setImage(@DrawableRes int resource) {
        this.mImage = resource;
        return this;
    }

    /**
     * Add a new group that will display a header in this AboutAppPage
     * <p>
     * A header will be displayed in the order it was added. For e.g:
     * <p>
     * <code>
     * new AboutAppPage(this)
     * .addItem(firstItem)
     * .addGroup("Header")
     * .addItem(secondItem)
     * .create();
     ...
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage addGroup(String name) {
     ...
     * @return this AboutAppPage instance for builder pattern support
     */
    public AboutDevelopersPage isRTL(boolean value) {
        this.mIsRTL = value;
        return this;
    }

    public AboutDevelopersPage setDescription(CharSequence description) {
        this.mDescription = description;
        return this;
    }

    /**
     * Create and inflate this AboutAppPage. After this method is called the AboutAppPage
     * cannot be customized any more.
     *
     * @return the inflated {@link View} of this AboutAppPage
     */
    public View create() {
        ...
        if (element.getIconDrawable() != null) {
            ...
            if (element.getAutoApplyIconTint()) {
                ...
                if (currentNightMode != Configuration.UI_MODE_NIGHT_YES) {
                    ...
                    DrawableCompat.setTint(wrappedDrawable, AboutDevelopersPageUtils.getThemeAccentColor(mContext));
                }
            }
    ...
    private View getSeparator() {
        return mInflater.inflate(R.layout.about_developers_page_separator, null);
    }
}
